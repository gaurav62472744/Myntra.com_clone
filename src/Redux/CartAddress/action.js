...
const deleteAddressSuccess=(payload)=>{
    return {
      type:DELETE_ADDRESS_SUCCESS,payload
    }
}
...
export const addAddress=(name, mobile, pinCode, address, locality, city, state) => (dispatch) => {
    const payload = {
      name,
      mobile,
      pinCode,
   ...
   return axios.post(`https://wadrobe.onrender.com/address`,payload)
      .then((res) => {
        console.log(res);
 ...
 export const deleteAddress=(id)=>(dispatch)=>{
   return axios.delete(`https://wadrobe.onrender.com/address/${id}`)
    .then((res)=>{
      console.log(res)
